...
public abstract class CollapsePanel<TR, T, H extends View, B extends View> 
	...
	protected CollapsePanel<TR, T, H, B> setNext(Collapsable n) {
		next = n;
		return this;
	}
	...
	public abstract CollapsePanel<TR, T, H, B> setValue(T value);
	
	public CollapsePanel<TR, T, H, B> collapse(boolean collapsed) {
